...
Программа создаётся в Odin. [Подробнее](https://www.odin.study/help/instrukcii-po-rabote/dobavit-programmu-v-ramkakh-proekta-kadry)
...
![](./rabota-s-programmoi-2.png){width=1467px height=616px}
...
При создании или редактировании программы доступен выпадающий список с **категориями граждан**. Это категории, которые закреплены [в постановлении](http://publication.pravo.gov.ru/document/0001202503100038?index=1) и на портале «Работа России». Можно отметить одну, несколько категорий или воспользоваться общим чек-боксом «Выбрать все».

![](./rabota-s-programmoi.jpeg){width=851px height=374px}

### Шаг4. Отправить на согласование к ФО

После заполнения всей необходимой информации отправить программу на согласование Федеральному оператору (после заполнения всех обязательных полей кнопка станет зелёной и активной).
