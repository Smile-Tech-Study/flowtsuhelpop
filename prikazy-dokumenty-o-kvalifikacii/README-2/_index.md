...
![](./README-2.png){width=2896px height=1414px}
...
![](./README.png){width=2902px height=1192px}
...
1\.После внесения данных по документам о квалификации во Flow на главной странице Flow появится информация о задачах по переносу данных на портал Работа России.

![](./README-4.png){width=1524px height=420px}
