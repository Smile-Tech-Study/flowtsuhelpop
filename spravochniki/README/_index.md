...
-  Подписывает открепленной подписью. [Как это сделать?](./../../scenarii/digital_signature/_index)
...
Регулярно происходит рассылка уведомлений, если статусы договора:  "Заблокирован договор на организацию обучения" и "Договор на организацию обучения близок к блокировке». Проверка выполняется ежедневно. Уведомление о фактической блокировке отправляется однократно, а предупреждение о приближении к блокировке повторяется ежедневно, пока расчетные показатели договора остаются в заданном диапазоне. Отсутствие нового набора и наличие загруженных ДЗС повторную отправку предупреждения не останавливают.