...
Акт генерируется строго на основании Задания. Один Акт должен включать не менее одного задания. Акт без Задания сгенерироваться не сможет.

**Пошаговая инструкция во  Flow**

1\. Перейти на страницу потока: Обучение - Потоки  - кликнуть по названию потока.

2\. В блоке «Заявки» в списке со слушателями потока отметить галочками либо всех слушателей, либо тех, на кого необходимо сгенерировать Акт и "Сохранить список слушателей".
...
-  зарегистрированы  Задания на поток,

-  в заявке есть скан приказа о зачислении,

-  в заявке есть  скан приказа об отчислении (тип приказа с успешным завершением),
...
4\. После окончания проверки цифрового следа в Odin (15 рабочих дней) и отсутствии замечаний по результатам проверки ТГУ согласовывает Акт в системе Flow. Акт переходит в статус "Согласовано. На подписи".
