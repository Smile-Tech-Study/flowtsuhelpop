...
На следующий день (не ранее этой даты, позднее возможно) после старта потока **представитель федерального оператора**  в таблице Образование - Потоки обучения фильтрует столбец «Статус заданий» по статусу "Готов к генерации".
