...
2. В Отчет попадают только те граждане, которые были указаны в связанном Акте, и у которых есть пометка о занятости, поступающая в систему автоматически (форма занятости не важна). Учитываться будут все граждане, даже те, кто завершил неуспешно. Не будут учиться граждане из потоков, которые отправлены в архив. 
