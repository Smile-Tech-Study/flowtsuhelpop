...
На странице заявки в блоке сканы документов надо выбрать "Действия", далее функцию "Создать/Заменить документы". Кнопка будет доступна пользователям, которым открыт доступ к Созданию/редактированию документов.

![](./zamena-dokumentov.png){width=670px height=575px}

Далее выберите документ, который необходимо заменить. Загрузите верный файл с компьютера. Сохраните изменения.

:::tip 

Создать возможно **только Заявление на отчисление по собственному желанию**. Другие документы создавать **запрещено**.

Добавить заявление на отчисление по собственному желанию можно из заявки, если есть право «Может ли заменять документы (для образовательного партнера)» (включается по запросу, только для роли сотрудника ОП, требуется файл-основание). Два ограничения: создание невозможно без приказа о зачислении и если по потоку уже есть акт оказания услуг, одобренный ФО. Загруженное сотрудником заявление сразу получает статус «Подтверждено».

![](./zamena-dokumentov.webp){width=1848px height=848px}
