...
title: Подписание Договора о намерениях
order: 2
---

Образовательная организация - первая сторона, подписывающая договор о намерениях после его генерации. Исключение - категория "Безработные граждане", для них первая сторона - ЦЗН.
...
2. Подписание договора первой стороной - **образовательная организация/ЦЗН** (только для категории безработные, зарегистрированные в ЦЗН)**.**  Доступно сразу/через несколько часов после генерации.
