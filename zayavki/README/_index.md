...
-  Первичные документы: скан главной страницы паспорта и страницы с регистрацией, если требуется, документ о текущем образовании и, снова если требуется, документ о смене фамилии. ***Документы загружает сам гражданин через свой ЛК.***
